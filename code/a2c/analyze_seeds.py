"""Aggregate A2C training runs across seeds.

Reads `reward_100` from every `runs/*-pong-a2c-seed*` TensorBoard event file,
...
def main():
    ...
    pattern = os.path.join(args.runs_dir, "*pong-a2c-seed*")
    ...
    ax.set_title("A2C on Pong: learning curves across seeds")
    ...
    ax2.set_title("A2C on Pong: per-seed sample-efficiency (AUC)")
